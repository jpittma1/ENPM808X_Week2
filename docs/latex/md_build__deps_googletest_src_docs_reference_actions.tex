...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_docs_reference_actions_autotoc_md242}{}\doxysection{Side Effects}\label{md_build__deps_googletest_src_docs_reference_actions_autotoc_md242}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_docs_reference_actions_autotoc_md243}{}\doxysection{Using a Function, Functor, or Lambda as an Action}\label{md_build__deps_googletest_src_docs_reference_actions_autotoc_md243}
...
calls the mock function\textquotesingle{}s \#2 argument, passing to it {\ttfamily 5} and {\ttfamily string(\char`\"{}\+Hi\char`\"{})} by value, and {\ttfamily foo} by reference.\hypertarget{md_build__deps_googletest_src_docs_reference_actions_autotoc_md244}{}\doxysection{Default Action}\label{md_build__deps_googletest_src_docs_reference_actions_autotoc_md244}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\{\+: .callout .note\} {\bfseries{Note\+:}} due to technical reasons, {\ttfamily \mbox{\hyperlink{namespacetesting_ae041df61ff61ccb9753ba15b4309e1a6}{Do\+Default()}}} cannot be used inside a composite action -\/ trying to do so will result in a run-\/time error.\hypertarget{md_build__deps_googletest_src_docs_reference_actions_autotoc_md245}{}\doxysection{Composite Actions}\label{md_build__deps_googletest_src_docs_reference_actions_autotoc_md245}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_docs_reference_actions_autotoc_md246}{}\doxysection{Defining Actions}\label{md_build__deps_googletest_src_docs_reference_actions_autotoc_md246}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
