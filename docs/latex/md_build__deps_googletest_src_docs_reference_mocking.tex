...
See details for each modifier clause below.\hypertarget{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md260}{}\doxysubsubsection{With \{\#\+EXPECT\+\_\+\+CALL.\+With\}}\label{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md260}
...
The {\ttfamily With} clause can be used at most once on an expectation and must be the first clause.\hypertarget{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md261}{}\doxysubsubsection{Times \{\#\+EXPECT\+\_\+\+CALL.\+Times\}}\label{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md261}
...
The {\ttfamily Times} clause can be used at most once on an expectation.\hypertarget{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md262}{}\doxysubsubsection{In\+Sequence \{\#\+EXPECT\+\_\+\+CALL.\+In\+Sequence\}}\label{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md262}
...
See also the \href{\#InSequence}{\texttt{ {\ttfamily In\+Sequence} class}}.\hypertarget{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md263}{}\doxysubsubsection{After \{\#\+EXPECT\+\_\+\+CALL.\+After\}}\label{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md263}
...
The {\ttfamily After} clause can be used any number of times on an expectation.\hypertarget{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md264}{}\doxysubsubsection{Will\+Once \{\#\+EXPECT\+\_\+\+CALL.\+Will\+Once\}}\label{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md264}
...
The {\ttfamily Will\+Once} clause can be used any number of times on an expectation. Unlike {\ttfamily Will\+Repeatedly}, the action fed to each {\ttfamily Will\+Once} call will be called at most once, so may be a move-\/only type and/or have an {\ttfamily \&\&}-\/qualified call operator.\hypertarget{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md265}{}\doxysubsubsection{Will\+Repeatedly \{\#\+EXPECT\+\_\+\+CALL.\+Will\+Repeatedly\}}\label{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md265}
...
The {\ttfamily Will\+Repeatedly} clause can be used at most once on an expectation.\hypertarget{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md266}{}\doxysubsubsection{Retires\+On\+Saturation \{\#\+EXPECT\+\_\+\+CALL.\+Retires\+On\+Saturation\}}\label{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md266}
...
See details for each modifier clause below.\hypertarget{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md267}{}\doxysubsubsection{With \{\#\+ON\+\_\+\+CALL.\+With\}}\label{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md267}
{\ttfamily .With(}$\ast${\ttfamily multi\+\_\+argument\+\_\+matcher}$\ast${\ttfamily )}
...
The {\ttfamily With} clause can be used at most once with each {\ttfamily ON\+\_\+\+CALL} statement.\hypertarget{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md268}{}\doxysubsubsection{Will\+By\+Default \{\#\+ON\+\_\+\+CALL.\+Will\+By\+Default\}}\label{md_build__deps_googletest_src_docs_reference_mocking_autotoc_md268}
...
{\ttfamily \mbox{\hyperlink{classtesting_1_1_default_value}{testing\+::\+Default\+Value}}$<$T$>$}
...
{\ttfamily \mbox{\hyperlink{classtesting_1_1_nice_mock}{testing\+::\+Nice\+Mock}}$<$T$>$}
...
{\ttfamily \mbox{\hyperlink{classtesting_1_1_naggy_mock}{testing\+::\+Naggy\+Mock}}$<$T$>$}
...
\mbox{\hyperlink{class_mock}{Mock}} objects of type {\ttfamily T} by default behave the same way as {\ttfamily Naggy\+Mock$<$T$>$}.\hypertarget{md_build__deps_googletest_src_docs_reference_mocking_StrictMock}{}\doxysubsection{Strict\+Mock}\label{md_build__deps_googletest_src_docs_reference_mocking_StrictMock}
{\ttfamily \mbox{\hyperlink{classtesting_1_1_strict_mock}{testing\+::\+Strict\+Mock}}$<$T$>$}
