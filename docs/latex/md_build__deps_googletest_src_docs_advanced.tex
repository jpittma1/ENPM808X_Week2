...
Google\+Test gives you three different options to solve this problem\+:\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md16}{}\doxysubsubsection{Using an Existing Boolean Function}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md16}
...
Related to the assertions {\ttfamily \mbox{\hyperlink{gtest_8h_a75adcdf89f69b0b615e395daafc315af}{SUCCEED()}}} and {\ttfamily \mbox{\hyperlink{gtest_8h_a3e26a8d27caa386ed0ea7ce9d5b7c4ed}{FAIL()}}}, you can prevent further test execution at runtime with the {\ttfamily \mbox{\hyperlink{gtest_8h_a3c0bbb980d533108ecc23c3534527d3c}{GTEST\+\_\+\+SKIP()}}} macro. This is useful when you need to check for preconditions of the system under test during runtime and skip tests in a meaningful way.

{\ttfamily \mbox{\hyperlink{gtest_8h_a3c0bbb980d533108ecc23c3534527d3c}{GTEST\+\_\+\+SKIP()}}} can be used in individual test cases or in the {\ttfamily Set\+Up()} methods of classes derived from either {\ttfamily \mbox{\hyperlink{classtesting_1_1_environment}{testing\+::\+Environment}}} or {\ttfamily \mbox{\hyperlink{classtesting_1_1_test}{testing\+::\+Test}}}. For example\+:
...
As with assertion macros, you can stream a custom message into {\ttfamily \mbox{\hyperlink{gtest_8h_a3c0bbb980d533108ecc23c3534527d3c}{GTEST\+\_\+\+SKIP()}}}.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md27}{}\doxysection{Teaching Google\+Test How to Print Your Values}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md27}
...
For more details regarding {\ttfamily Absl\+Stringify()} and its integration with other libraries, see go/abslstringify.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md28}{}\doxysection{Death Tests}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md28}
...
If you want to test {\ttfamily EXPECT\+\_\+$\ast$()/\+ASSERT\+\_\+$\ast$()} failures in your test code, see \href{\#catching-failures}{\texttt{ \char`\"{}\+Catching\char`\"{} Failures}}.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md29}{}\doxysubsection{How to Write a Death Test}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md29}
...
In particular, if {\ttfamily statement} generates an {\ttfamily ASSERT\+\_\+$\ast$} or {\ttfamily EXPECT\+\_\+$\ast$} failure, it will {\bfseries{not}} cause the death test to fail, as Google\+Test assertions don\textquotesingle{}t abort the process.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md30}{}\doxysubsection{Death Test Naming}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md30}
...
If {\ttfamily Has\+Fatal\+Failure()} is used outside of {\ttfamily \mbox{\hyperlink{gtest_8h_ab5540a6d621853916be8240ff51819cf}{TEST()}}} , {\ttfamily \mbox{\hyperlink{gtest_8h_a0ee66d464d1a06c20c1929cae09d8758}{TEST\+\_\+\+F()}}} , or a test fixture, you must add the {\ttfamily \mbox{\hyperlink{classtesting_1_1_test}{testing\+::\+Test}}\+:\+:} prefix, as in\+:
...
Now, when {\ttfamily \mbox{\hyperlink{gtest_8h_a853a3792807489591d3d4a2f2ff9359f}{RUN\+\_\+\+ALL\+\_\+\+TESTS()}}} is called, it first calls the {\ttfamily Set\+Up()} method of each environment object, then runs the tests if none of the environments reported fatal failures and {\ttfamily \mbox{\hyperlink{gtest_8h_a3c0bbb980d533108ecc23c3534527d3c}{GTEST\+\_\+\+SKIP()}}} was not called. {\ttfamily \mbox{\hyperlink{gtest_8h_a853a3792807489591d3d4a2f2ff9359f}{RUN\+\_\+\+ALL\+\_\+\+TESTS()}}} always calls {\ttfamily Tear\+Down()} with each environment object, regardless of whether or not the tests were run.
...
Once they are defined, you can instantiate them by including {\ttfamily foo\+\_\+param\+\_\+test.\+h}, invoking {\ttfamily \mbox{\hyperlink{gtest-param-test_8h_a6a5cb3ce0a0fe17f84f357a6f39a4ba5}{INSTANTIATE\+\_\+\+TEST\+\_\+\+SUITE\+\_\+\+P()}}}, and depending on the library target that contains {\ttfamily foo\+\_\+param\+\_\+test.\+cc}. You can instantiate the same abstract test suite multiple times, possibly in different source files.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md48}{}\doxysubsection{Specifying Names for Value-\/\+Parameterized Test Parameters}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md48}
...
class Foo \{ friend class \mbox{\hyperlink{class_foo_test}{Foo\+Test}}; \mbox{\hyperlink{gtest__prod_8h_a8d443b4cc1d87a7a17943b8fbdbf3910}{FRIEND\+\_\+\+TEST(\+Foo\+Test, Bar)}}; \mbox{\hyperlink{gtest__prod_8h_a8d443b4cc1d87a7a17943b8fbdbf3910}{FRIEND\+\_\+\+TEST(\+Foo\+Test, Baz)}}; ... definition of the class Foo ... \};
...
{\ttfamily current\+\_\+test\+\_\+info()} returns a null pointer if no test is running. In particular, you cannot find the test suite name in {\ttfamily Set\+Up\+Test\+Suite()}, {\ttfamily Tear\+Down\+Test\+Suite()} (where you know the test suite name implicitly), or functions called from them.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md55}{}\doxysection{Extending Google\+Test by Handling Test Events}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md55}
...
To use the event listener you have defined, add an instance of it to the Google\+Test event listener list (represented by class \href{reference/testing.md\#TestEventListeners}{\texttt{ {\ttfamily Test\+Event\+Listeners}}} -\/ note the \char`\"{}s\char`\"{} at the end of the name) in your {\ttfamily \mbox{\hyperlink{app_2main_8cpp_ae66f6b31b5ad750f1fe042a706a4e3d4}{main()}}} function, before calling {\ttfamily \mbox{\hyperlink{gtest_8h_a853a3792807489591d3d4a2f2ff9359f}{RUN\+\_\+\+ALL\+\_\+\+TESTS()}}}\+:
...
{\itshape }\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md75}{}\doxysubsubsection{Generating a JSON Report}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md75}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md76}{}\doxysubsection{Controlling How Failures Are Reported}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md76}
{\itshape  }\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md77}{}\doxysubsubsection{Detecting Test Premature Exit}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md77}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md78}{}\doxysubsubsection{Turning Assertion Failures into Break-\/\+Points}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md78}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md79}{}\doxysubsubsection{Disabling Catching Test-\/\+Thrown Exceptions}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md79}
...
{\itshape }\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md80}{}\doxysubsection{Sanitizer Integration}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md80}
