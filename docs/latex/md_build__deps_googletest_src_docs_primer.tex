\hypertarget{md_build__deps_googletest_src_docs_primer_autotoc_md222}{}\doxysection{Introduction\+: Why Google\+Test?}\label{md_build__deps_googletest_src_docs_primer_autotoc_md222}
...
Since Google\+Test is based on the popular x\+Unit architecture, you\textquotesingle{}ll feel right at home if you\textquotesingle{}ve used JUnit or Py\+Unit before. If not, it will take you about 10 minutes to learn the basics and get started. So let\textquotesingle{}s go!\hypertarget{md_build__deps_googletest_src_docs_primer_autotoc_md223}{}\doxysection{Beware of the Nomenclature}\label{md_build__deps_googletest_src_docs_primer_autotoc_md223}
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_docs_primer_autotoc_md224}{}\doxysection{Basic Concepts}\label{md_build__deps_googletest_src_docs_primer_autotoc_md224}
...
We\textquotesingle{}ll now explain how to write a test program, starting at the individual assertion level and building up to tests and test suites.\hypertarget{md_build__deps_googletest_src_docs_primer_autotoc_md225}{}\doxysection{Assertions}\label{md_build__deps_googletest_src_docs_primer_autotoc_md225}
...
Google\+Test provides a collection of assertions for verifying the behavior of your code in various ways. You can check Boolean conditions, compare values based on relational operators, verify string values, floating-\/point values, and much more. There are even assertions that enable you to verify more complex states by providing custom predicates. For the complete list of assertions provided by Google\+Test, see the \mbox{\hyperlink{md_build__deps_googletest_src_docs_reference_assertions}{Assertions Reference}}.\hypertarget{md_build__deps_googletest_src_docs_primer_autotoc_md226}{}\doxysection{Simple Tests}\label{md_build__deps_googletest_src_docs_primer_autotoc_md226}
To create a test\+:
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_docs_primer_autotoc_md227}{}\doxysection{Invoking the Tests}\label{md_build__deps_googletest_src_docs_primer_autotoc_md227}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_docs_primer_autotoc_md228}{}\doxysection{Writing the main() Function}\label{md_build__deps_googletest_src_docs_primer_autotoc_md228}
...
But maybe you think that writing all those {\ttfamily main} functions is too much work? We agree with you completely, and that\textquotesingle{}s why Google Test provides a basic implementation of \mbox{\hyperlink{app_2main_8cpp_ae66f6b31b5ad750f1fe042a706a4e3d4}{main()}}. If it fits your needs, then just link your test with the {\ttfamily gtest\+\_\+main} library and you are good to go.

\{\+: .callout .note\} NOTE\+: {\ttfamily Parse\+GUnit\+Flags()} is deprecated in favor of {\ttfamily \mbox{\hyperlink{namespacetesting_afd726ae08c9bd16dc52f78c822d9946b}{Init\+Google\+Test()}}}.\hypertarget{md_build__deps_googletest_src_docs_primer_autotoc_md229}{}\doxysection{Known Limitations}\label{md_build__deps_googletest_src_docs_primer_autotoc_md229}
