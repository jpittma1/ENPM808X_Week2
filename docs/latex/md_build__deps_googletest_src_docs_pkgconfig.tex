...
All current build systems support pkg-\/config in one way or another. For all examples here we assume you want to compile the sample {\ttfamily \mbox{\hyperlink{sample3__unittest_8cc}{samples/sample3\+\_\+unittest.\+cc}}}.\hypertarget{md_build__deps_googletest_src_docs_pkgconfig_autotoc_md217}{}\doxysubsection{CMake}\label{md_build__deps_googletest_src_docs_pkgconfig_autotoc_md217}
